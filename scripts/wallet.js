...
export class Wallet {
    ...
    async #loadShieldFromDisk() {
        ...
        // Provided data are not compatible with the latest ZENZO shield version.
     ...
     * @param {boolean} [opts.isDelegation] - Whether or not this delegates ZNZs to `address`.
     ...
     *     Only changes >= 1 ZNZ can be delegated
     ...
     * @param block - block outputted from any ZENZO node
