...
/** The fee in Sats to use for Creating or Redeeming ZENZO Promos */
...
/**
 * Sets the mode of the ZENZO Promos UI
...
/**
 * Create a new 'ZENZO Promos' code with a webworker
...
/** Export and download all ZENZO Promos data in to a CSV format */
export async function promosToCSV() {
    const arrCSV = [
        // Titles
        ['Promo Code', 'ZNZ (Remaining)', 'Funding Address'],
        // Content
    ];
...
/**
 * @type {Worker?} - The thread used for the ZENZO Promos redeem process
 */
export let promoThread = null;

/**
 * Derive a 'ZENZO Promos' code with a webworker
...
/**
 * Prompt a QR scan for a ZENZO Promos code
 */
