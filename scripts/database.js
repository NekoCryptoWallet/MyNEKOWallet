...
export class Database {
    ...
    async addAccount(account) {
        ...
        if (!(account instanceof Account)) {
            ...
            createAlert(
                'warning',
                '<b>Account Creation Error</b><br>Logs were dumped in your Browser Console<br>Please submit these privately to ZENZO Labs Developers!'
            );
            throw new Error(
    ...
    async updateAccount(account, allowDeletion = false) {
        ...
        if (!(account instanceof Account)) {
            ...
            createAlert(
                'warning',
                '<b>DB Update Error</b><br>Your wallet is safe, logs were dumped in your Browser Console<br>Please submit these privately to ZENZO Labs Developers!'
            );
            throw new Error(
                'addAccount was called with with an invalid account'
            );
        ...
        if (!cDBAccount) {
            ...
            createAlert(
                'warning',
                '<b>DB Update Error</b><br>Logs were dumped in your Browser Console<br>Please submit these privately to ZENZO Labs Developers!'
            );
            throw new Error(
