...
async function setupConnection() {
    ...
    if (!cHardwareWallet || transport._disconnectEmitted) {
        ...
        cHardwareWallet = new AppBtc({ transport, currency: 'ZENZO' });
    }
}
/**
...
export const LEDGER_ERRS = new Map([
    ...
    [25870, 'Open the ZENZO app on your device'],
    [25873, 'Open the ZENZO app on your device'],
    [57408, 'Navigate to the ZENZO app on your device'],
    [27157, 'Wrong app! Open the ZENZO app on your device'],
    [27266, 'Wrong app! Open the ZENZO app on your device'],
    [27904, 'Wrong app! Open the ZENZO app on your device'],
